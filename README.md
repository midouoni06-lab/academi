...
<title>أكاديمية فيلسوف الصغير - رئيسية</title>
...
<nav>
  <img src="h
<!-- #endregion -->    <div> 
      <h2>أكاديمية فيلسوف الصغير</h2>
      <div style="font-size:12px;opacity:.9">منصة تعليمية للطفل </div>
    </div>
  </div>
...
<div class="container">
  <section class="hero">
    <h1>مرحبًا بكم في أكاديمية فيلسوف الصغير 🎓</h1>
  ...
  <section class="grid" id="stagesGrid">
    <div class="card">
      ...
      <button
utton onclick="openStage('2')">ابدأ التعلم</button>
    </div>
    <div class="card">
  ...
  <footer style="margin-top:50px;border-radius:45px">
    © 2025 أكاديمية فيلسوف الصغير – جميع الحقوق محفوظة.
  </footer>
</div>
...
<script type="module">
  ...
  import { getFirestore, doc, setDoc, getDoc, collection, addDoc, query, where,
getDocs } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-firestore.js";
